...
function gerarRelatorio(){
  ...
  const Cafes = parseInt(document.getElementById("Cafe").value);
  const Chas = parseInt(document.getElementById("Chas").value);
  const temperatura = parseInt(document.getElementById("Temperatura").value);
  const Copos = parseInt(document.getElementById("Copos").value);
  const Xicaras = parseInt(document.getElementById("Xicara").value);
  const Chocolate = parseInt(document.getElementById("Chocolate").value);
  const acucar = parseInt(document.getElementById("acucar").value);
  const caldas = parseInt(document.getElementById("caldas").value);
  const leite = parseInt(document.getElementById("leite").value);

  var Cafe = procurarPorId(Cafes, CafesId);
  var Cha = procurarPorId(Chas, ChasId);
  var Temperatura = procurarPorId(temperatura, temperaturaId);
  var Copo = procurarPorId(Copos, CoposId);
  var Xicara = procurarPorId(Xicaras, XicarasId);
  var Chocolates = procurarPorId(Chocolate, ChocolateId);
  var Acucar = procurarPorId(acucar, acucarId);
  var Caldas = procurarPorId(caldas, caldasId);
  var Leite = procurarPorId(leite, leiteId);
